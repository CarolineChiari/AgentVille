 ...
 * @property {{ id: string, kind: number, color: number, x: number, y: number, plot: string, born: number|null, selected: boolean, hovered: boolean }[]} flowers
 *           Finished threads; (x, y) is the base of the stem. `born` is sim time, null if always there.
